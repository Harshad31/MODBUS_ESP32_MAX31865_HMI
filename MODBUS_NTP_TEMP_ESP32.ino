...
void loop() {
  ...
  if (getLocalTime(&timeinfo)) {
    ...
    holdingRegisters[1] = timeinfo.tm_hour;  // Hours in Holding Register 1
    holdingRegisters[2] = timeinfo.tm_min;   // Minutes in Holding Register 2
    holdingRegisters[3] = timeinfo.tm_sec;   // Seconds in Holding Register 3
    holdingRegisters[4] = ms;                // Milliseconds in Holding Register 4
